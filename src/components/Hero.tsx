    ...
    >
      <BentoGrid className="max-w-4xl mx-auto px-4">
        ...
        <BentoGridItem
          ...
          title={
            <span className="text-xl font-heading text-neutral-900 dark:text-neutral-200">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {["Next.js", "React", "TypeScript", "Tailwind", "Node.js"].map(
                (tech) => (
                  <span
                    key={tech}
                    className="px-2 py-1 text-[10px] font-bold uppercase tracking-wider rounded-md bg-neutral-100 text-neutral-600 border border-neutral-200 dark:bg-neutral-800 dark:text-neutral-300 dark:border-neutral-700"
                  >
                    {tech}
                  </span>
                )
        ...
        >
          <BentoGridItem
            ...
            description={
              <span className="text-blue-50 text-xs">
        ...
        >
          <BentoGridItem
            ...
            header={
              <GitHubLogoIcon className="h-8 w-8 text-neutral-900 dark:text-neutral-200 mb-auto" />
            }
          />
        </a>
        ...
        {/* Contact Tile */}
        <BentoGridItem
          className="md:col-span-7  bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800 shadow-sm"
          title={
          ...
          header={
            <div className="h-full min-h-[4rem] flex items-center justify-center text-neutral-500 text-sm border border-dashed border-neutral-300 dark:border-neutral-700 rounded-lg bg-neutral-50 dark:bg-neutral-800/50">
              Status: Open to Work
            </div>
          }
        ...
        {/* Discord Status Tile */}
        <BentoGridItem
          className="md:col-span-5 bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800 shadow-sm"
          title={
            <span className="font-heading text-neutral-900 dark:text-neutral-200">
              What am I upto?
            </span>
