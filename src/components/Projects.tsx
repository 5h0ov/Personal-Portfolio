...
const Projects = () => {
  ...
  return (
    <section
      id="projects"
      className="py-24 relative overflow-hidden bg-neutral-100 dark:bg-neutral-900/50"
    >
                ...
                icon={
                  <div className="flex flex-wrap gap-2 mt-2">
                    {project.tech.slice(0, 3).map((t) => (
                      <span
                        key={t}
                        className="text-[10px] font-bold uppercase tracking-wider px-2 py-1 bg-neutral-100 dark:bg-neutral-800 rounded-md border border-neutral-200 dark:border-neutral-700"
                      >
                        {t}
                      </span>
                    ))}
